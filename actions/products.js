...
export const getRandomProducts = () => async (dispatch) => {
    dispatch({
        type: GET_RANDOM_PRODUCTS_REQUEST,
    });

    try {
        const res = await api.get('/products/randomproducts');
        console.log(res);
        dispatch({
...
//         dispatch(loadUser());
//         dispatch(
//             setAlert('Successfully removed from your wishlist', 'success')
//         );
...
//     try {
//         const res = await api.get('/products/vendor/todayproducts');
...
//         });
//         dispatch(
//             setAlert('Product succesfully deleted from catalogue', 'success')
//         );
//         dispatch(loadMyPlug());
//         console.log(res.data);
//     } catch (err) {
