    ...
    switch (action.type) {
        ...
        case GET_PRODUCT_SUCCESS:
            return {
                ...
                similar: action.payload.sameBrand,
            };
...
export const getRandomProductsReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        case GET_RANDOM_PRODUCTS_REQUEST:
            return {
                loading: true,
            };
